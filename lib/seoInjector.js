...
function buildSeoTags(content, lang = 'ar') {
  ...
  // Ensure OG image is JPG-compatible (Facebook rejects WebP/AVIF)
  if (ogImageUrl && typeof ogImageUrl === 'string' && /\.(webp|avif)$/i.test(ogImageUrl)) {
    ogImageUrl = ogImageUrl.replace(/\.(webp|avif)$/i, '.jpg');
  }
